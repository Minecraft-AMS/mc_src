...
extends Enum<NetworkState> {
    ...
    private static final /* synthetic */ NetworkState[] field_11694;

    public static NetworkState[] values() {
        return (NetworkState[])field_11694.clone();
    }
    ...
    public Int2ObjectMap<Class<? extends Packet<?>>> getPacketIdToPacketMap(NetworkSide side) {
        ...
        packetHandler.packetIds.forEach((arg_0, arg_1) -> NetworkState.method_39497((Int2ObjectMap)int2ObjectMap, arg_0, arg_1));
    ...
    private static /* synthetic */ void method_39497(Int2ObjectMap clazz, Class packetId, Integer integer) {
        clazz.put(integer.intValue(), (Object)packetId);
    }

    private static /* synthetic */ NetworkState[] method_36943() {
        return new NetworkState[]{HANDSHAKING, PLAY, STATUS, LOGIN};
    }

    static {
        field_11694 = NetworkState.method_36943();
    ...
    static class PacketHandler<T extends PacketListener> {
        ...
        final Object2IntMap<Class<? extends Packet<T>>> packetIds = (Object2IntMap)Util.make(new Object2IntOpenHashMap(), map -> map.defaultReturnValue(-1));
