...
implements Packet<ClientPlayPacketListener> {
    ...
    public GameJoinS2CPacket(int playerEntityId, GameMode gameMode, boolean hardcore, DimensionType dimension, int maxPlayers, LevelGeneratorType generatorType, int chunkLoadDistance, boolean reducedDebugInfo) {
