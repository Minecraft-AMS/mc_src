...
extends SpriteBillboardParticle {
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        this.buildGeometry(vertexConsumer, camera, tickDelta, quaternion -> quaternion.mul((Quaternionfc)new Quaternionf().rotationX(-1.0472f)));
        this.buildGeometry(vertexConsumer, camera, tickDelta, quaternion -> quaternion.mul((Quaternionfc)new Quaternionf().rotationYXZ((float)(-Math.PI), 1.0472f, 0.0f)));
    }
