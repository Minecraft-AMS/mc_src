    ...
    implements FontLoader {
        ...
        public Font load(ResourceManager manager) {
            try (Resource resource = manager.getResource(this.filename);){
                ...
                Char2ObjectOpenHashMap char2ObjectMap = new Char2ObjectOpenHashMap();
                int m = 0;
                while (true) {
                    String string;
                    if (m < this.chars.size()) {
                        ...
                        TextureFont textureFont = new TextureFont(nativeImage, (Char2ObjectMap<TextureFontGlyph>)char2ObjectMap);
                        return textureFont;
                    }
                    for (int n = 0; n < string.length(); ++n) {
                        ...
                        if (c == '\u0000' || c == ' ' || (textureFontGlyph = (TextureFontGlyph)char2ObjectMap.put(c, (Object)new TextureFontGlyph(f, nativeImage, n * k, m * l, k, l, (int)(0.5 + (double)((float)(o = this.findCharacterStartX(nativeImage, k, l, n, m)) * f)) + 1, this.ascent))) == null) continue;
