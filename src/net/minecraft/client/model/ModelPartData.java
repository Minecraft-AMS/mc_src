...
public class ModelPartData {
    ...
    public ModelPart createPart(int textureWidth, int textureHeight) {
        ...
        List list = (List)this.cuboidData.stream().map(modelCuboidData -> modelCuboidData.createCuboid(textureWidth, textureHeight)).collect(ImmutableList.toImmutableList());
