...
extends SinglePartEntityModelWithChildTransform<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData4 = modelPartData3.addChild("head", ModelPartBuilder.create().uv(8, 15).cuboid(-6.5f, -7.5f, -11.5f, 13.0f, 18.0f, 11.0f, new Dilation(0.0f)).uv(8, 4).cuboid(-6.5f, 7.5f, -11.5f, 13.0f, 0.0f, 11.0f, new Dilation(0.0f)), ModelTransform.pivot(0.0f, 6.5f, -19.5f));
        modelPartData4.addChild("left_ear", ModelPartBuilder.create().uv(2, 0).cuboid(0.0f, 0.0f, -3.0f, 1.0f, 19.0f, 7.0f, new Dilation(0.0f)), ModelTransform.pivot(6.5f, -7.5f, -4.5f));
        modelPartData4.addChild("right_ear", ModelPartBuilder.create().uv(48, 0).cuboid(-1.0f, 0.0f, -3.0f, 1.0f, 19.0f, 7.0f, new Dilation(0.0f)), ModelTransform.pivot(-6.5f, -7.5f, -4.5f));
