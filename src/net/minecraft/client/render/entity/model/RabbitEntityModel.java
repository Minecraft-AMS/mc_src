...
extends EntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
        if (this.child) {
            ...
            ImmutableList.of((Object)this.head, (Object)this.leftEar, (Object)this.rightEar, (Object)this.nose).forEach(modelPart -> modelPart.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha));
            matrices.pop();
            matrices.push();
            matrices.scale(0.4f, 0.4f, 0.4f);
            matrices.translate(0.0, 2.25, 0.0);
            ImmutableList.of((Object)this.leftFoot, (Object)this.rightFoot, (Object)this.leftBackLeg, (Object)this.rightBackLeg, (Object)this.torso, (Object)this.leftFrontLeg, (Object)this.rightFrontLeg, (Object)this.tail).forEach(modelPart -> modelPart.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha));
            matrices.pop();
        } else {
            matrices.push();
