...
extends Screen {
    ...
    private void openPackScreen() {
        ...
        if (pair != null) {
            this.client.setScreen(new PackScreen(this, (ResourcePackManager)pair.getSecond(), this::applyDataPacks, (Path)pair.getFirst(), Text.translatable("dataPack.title")));
        }
    }
    ...
    private void applyDataPacks(ResourcePackManager dataPackManager) {
        ...
        DataConfiguration dataConfiguration = new DataConfiguration(new DataPackSettings((List<String>)list, list2), this.dataConfiguration.enabledFeatures());
