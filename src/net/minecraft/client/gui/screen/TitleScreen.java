...
extends Screen {
    ...
    @Environment(value=EnvType.CLIENT)
    static final class DeprecationNotice
    extends Record {
        ...
        DeprecationNotice(MultilineText multilineText, int i, int j, CompletableFuture<Boolean> completableFuture) {
            this.label = multilineText;
            this.x = i;
            this.y = j;
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{DeprecationNotice.class, "label;x;y;realmsSubscriptionFuture", "label", "x", "y", "realmsSubscriptionFuture"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{DeprecationNotice.class, "label;x;y;realmsSubscriptionFuture", "label", "x", "y", "realmsSubscriptionFuture"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{DeprecationNotice.class, "label;x;y;realmsSubscriptionFuture", "label", "x", "y", "realmsSubscriptionFuture"}, this, object);
        }
