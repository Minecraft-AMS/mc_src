...
extends ContainerScreen<LoomContainer> {
    ...
    private static final List<DyeColor> PATTERN_BUTTON_COLORS = Lists.newArrayList((Object[])new DyeColor[]{PATTERN_BUTTON_BACKGROUND_COLOR, PATTERN_BUTTON_FOREGROUND_COLOR});
    ...
    public void tick() {
        ...
        if (this.lastCachedPatternButtonTextureId < BannerPattern.COUNT) {
            ...
            this.patternButtonTextureIds[this.lastCachedPatternButtonTextureId] = TextureCache.BANNER.get(string + string2, Lists.newArrayList((Object[])new BannerPattern[]{BannerPattern.BASE, bannerPattern}), PATTERN_BUTTON_COLORS);
    ...
    protected void drawBackground(float delta, int mouseX, int mouseY) {
        ...
        if (this.output != null && !this.hasTooManyPatterns) {
            ...
            LoomScreen.blit(i + 141, j + 8, 20, 40, 1.0f, 1.0f, 20, 40, 64, 64);
        ...
        if (this.canApplyDyePattern) {
            ...
            for (int o = this.firstPatternButtonId; o < n && o < this.patternButtonTextureIds.length - 5; ++o) {
                ...
                if (this.patternButtonTextureIds[o] == null) continue;
                this.minecraft.getTextureManager().bindTexture(this.patternButtonTextureIds[o]);
                LoomScreen.blit(q + 4, r + 2, 5, 10, 1.0f, 1.0f, 20, 40, 64, 64);
            }
            ...
            if (this.patternButtonTextureIds[n] != null) {
                ...
                LoomScreen.blit(l + 4, m + 2, 5, 10, 1.0f, 1.0f, 20, 40, 64, 64);
            }
        }
    }
