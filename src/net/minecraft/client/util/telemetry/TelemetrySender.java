...
public class TelemetrySender {
    ...
    record PlayerGameMode(GameMode gameMode, boolean hardcore) {
        ...
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{PlayerGameMode.class, "gameType;hardcore", "gameMode", "hardcore"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{PlayerGameMode.class, "gameType;hardcore", "gameMode", "hardcore"}, this);
        }

        @Override
        public final boolean equals(Object o) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{PlayerGameMode.class, "gameType;hardcore", "gameMode", "hardcore"}, this, o);
        }
    }
}
