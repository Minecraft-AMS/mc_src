...
extends RealmsScreen {
    ...
    extends AlwaysSelectedEntryListWidget.Entry<BackupInfoListEntry> {
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            context.drawTextWithShadow(textRenderer, this.key, x, y, 0xA0A0A0);
            context.drawTextWithShadow(textRenderer, RealmsBackupInfoScreen.this.checkForSpecificMetadata(this.key, this.value), x, y + 12, 0xFFFFFF);
        }
