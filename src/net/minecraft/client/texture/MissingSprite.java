...
public final class MissingSprite {
    ...
    private static final AnimationResourceMetadata METADATA = new AnimationResourceMetadata((List<AnimationFrameResourceMetadata>)ImmutableList.of((Object)new AnimationFrameResourceMetadata(0, -1)), 16, 16, 1, false);
    @Nullable
