...
public class SpriteLoader {
    ...
    public StitchResult method_47663(List<SpriteContents> list, int i, Executor executor) {
        ...
        for (SpriteContents spriteContents : list) {
            ...
            if (m < l) {
                LOGGER.warn("Texture {} with size {}x{} limits mip level from {} to {}", new Object[]{spriteContents.getId(), spriteContents.getWidth(), spriteContents.getHeight(), MathHelper.floorLog2(l), MathHelper.floorLog2(m)});
                l = m;
            }
        ...
        if (o < i) {
            LOGGER.warn("{}: dropping miplevel from {} to {}, because of minimum power of two: {}", new Object[]{this.id, i, o, n});
            m = o;
        } else {
            m = i;
        }
