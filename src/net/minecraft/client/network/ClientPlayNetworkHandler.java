...
ClientPlayPacketListener {
    ...
    private ParseResults<CommandSource> parse(String command) {
        return this.commandDispatcher.parse(command, (Object)this.commandSource);
    }
    ...
    extends Record {
        ...
        QueuedPacket(Packet<ServerPlayPacketListener> packet, BooleanSupplier booleanSupplier, long l) {
            this.packet = packet;
        ...
        public Packet<ServerPlayPacketListener> packet() {
            return this.packet;
        }
