...
public class ParticleCommand {
    private static final SimpleCommandExceptionType FAILED_EXCPETION = new SimpleCommandExceptionType((Message)new TranslatableText("commands.particle.failed", new Object[0]));
