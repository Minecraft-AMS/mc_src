        ...
        for (ObjectType objectType : TARGET_OBJECT_TYPES) {
            objectType.addArgumentsToBuilder((ArgumentBuilder<ServerCommandSource, ?>)literalArgumentBuilder, builder -> {
                ...
                for (ObjectType objectType2 : SOURCE_OBJECT_TYPES) {
                    subArgumentAdder.accept((ArgumentBuilder<ServerCommandSource, ?>)argumentBuilder, operation -> objectType2.addArgumentsToBuilder((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("from"), builder -> builder.executes(context -> DataCommand.executeModify((CommandContext<ServerCommandSource>)context, objectType, operation, DataCommand.getValues((CommandContext<ServerCommandSource>)context, objectType2))).then(CommandManager.argument("sourcePath", NbtPathArgumentType.nbtPath()).executes(context -> DataCommand.executeModify((CommandContext<ServerCommandSource>)context, objectType, operation, DataCommand.getValuesByPath((CommandContext<ServerCommandSource>)context, objectType2))))));
                    subArgumentAdder.accept((ArgumentBuilder<ServerCommandSource, ?>)argumentBuilder, operation -> objectType2.addArgumentsToBuilder((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.literal("string"), builder -> builder.executes(context -> DataCommand.executeModify((CommandContext<ServerCommandSource>)context, objectType, operation, DataCommand.mapValues(DataCommand.getValues((CommandContext<ServerCommandSource>)context, objectType2), value -> value))).then(((RequiredArgumentBuilder)CommandManager.argument("sourcePath", NbtPathArgumentType.nbtPath()).executes(context -> DataCommand.executeModify((CommandContext<ServerCommandSource>)context, objectType, operation, DataCommand.mapValues(DataCommand.getValuesByPath((CommandContext<ServerCommandSource>)context, objectType2), value -> value)))).then(((RequiredArgumentBuilder)CommandManager.argument("start", IntegerArgumentType.integer((int)0)).executes(context -> DataCommand.executeModify((CommandContext<ServerCommandSource>)context, objectType, operation, DataCommand.mapValues(DataCommand.getValuesByPath((CommandContext<ServerCommandSource>)context, objectType2), value -> value.substring(IntegerArgumentType.getInteger((CommandContext)context, (String)"start")))))).then(CommandManager.argument("end", IntegerArgumentType.integer((int)0)).executes(context -> DataCommand.executeModify((CommandContext<ServerCommandSource>)context, objectType, operation, DataCommand.mapValues(DataCommand.getValuesByPath((CommandContext<ServerCommandSource>)context, objectType2), value -> value.substring(IntegerArgumentType.getInteger((CommandContext)context, (String)"start"), IntegerArgumentType.getInteger((CommandContext)context, (String)"end"))))))))));
                }
