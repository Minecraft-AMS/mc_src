...
public class DebugInfoSender {
    ...
    private static void writeBrain(LivingEntity entity, PacketByteBuf buf) {
        ...
        buf.writeOptional(brain.hasMemoryModule(MemoryModuleType.PATH) ? brain.getOptionalRegisteredMemory(MemoryModuleType.PATH) : Optional.empty(), (buf2, path) -> path.toBuffer((PacketByteBuf)((Object)buf2)));
