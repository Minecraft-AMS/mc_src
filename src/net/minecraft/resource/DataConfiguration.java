...
public record DataConfiguration(DataPackSettings dataPacks, FeatureSet enabledFeatures) {
    ...
    public static final Codec<DataConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)DataPackSettings.CODEC.optionalFieldOf("DataPacks", (Object)DataPackSettings.SAFE_MODE).forGetter(DataConfiguration::dataPacks), (App)FeatureFlags.CODEC.optionalFieldOf(ENABLED_FEATURES_KEY, (Object)FeatureFlags.DEFAULT_ENABLED_FEATURES).forGetter(DataConfiguration::enabledFeatures)).apply((Applicative)instance, DataConfiguration::new));
