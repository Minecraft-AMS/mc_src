...
public class StructureLocator {
    ...
    public void cache(ChunkPos pos, Map<ConfiguredStructureFeature<?, ?>, StructureStart> structureStarts) {
        ...
        this.cache(l, (Object2IntMap<ConfiguredStructureFeature<?, ?>>)object2IntMap);
    }
    ...
    public void incrementReferences(ChunkPos pos2, ConfiguredStructureFeature<?, ?> configuredStructureFeature) {
        this.cachedFeaturesByChunkPos.compute(pos2.toLong(), (pos, referencesByStructure) -> {
            ...
            referencesByStructure.computeInt((Object)configuredStructureFeature, (configuredStructureFeature, references) -> references == null ? 1 : references + 1);
            return referencesByStructure;
        });
    }

    private static /* synthetic */ void method_39839(Object2IntMap feature, ConfiguredStructureFeature configuredStructureFeature, StructureStart structureStart) {
        if (structureStart.hasChildren()) {
            feature.put((Object)configuredStructureFeature, structureStart.getReferences());
        }
    }
}
