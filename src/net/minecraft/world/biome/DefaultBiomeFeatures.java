...
public class DefaultBiomeFeatures {
    ...
    public static final BranchedTreeFeatureConfig JUNGLE_TREE_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(JUNGLE_LOG), new SimpleBlockStateProvider(JUNGLE_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(8).foliageHeight(3).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new CocoaBeansTreeDecorator(0.2f), (Object)new TrunkVineTreeDecorator(), (Object)new LeaveVineTreeDecorator())).noVines().build();
    ...
    public static final BranchedTreeFeatureConfig BIRCH_TREE_WITH_RARE_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BIRCH_LOG), new SimpleBlockStateProvider(BIRCH_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(5).heightRandA(2).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.002f))).build();
    public static final BranchedTreeFeatureConfig LARGE_BIRCH_TREE_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BIRCH_LOG), new SimpleBlockStateProvider(BIRCH_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(5).heightRandA(2).heightRandB(6).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.002f))).build();
    public static final BranchedTreeFeatureConfig SWAMP_TREE_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(3, 0)).baseHeight(5).heightRandA(3).foliageHeight(3).maxWaterDepth(1).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new LeaveVineTreeDecorator())).build();
    ...
    public static final BranchedTreeFeatureConfig OAK_TREE_WITH_MORE_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(2).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.05f))).build();
    public static final BranchedTreeFeatureConfig FANCY_TREE_WITH_RARE_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(0, 0)).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.002f))).build();
    public static final BranchedTreeFeatureConfig FANCY_TREE_WITH_MORE_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(0, 0)).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.05f))).build();
    public static final BranchedTreeFeatureConfig OAK_TREE_WITH_RARE_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(2).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.002f))).build();
    public static final BranchedTreeFeatureConfig OAK_TREE_WITH_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(4).heightRandA(2).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.02f))).build();
    public static final BranchedTreeFeatureConfig FANCY_TREE_WITH_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(OAK_LEAVES), new BlobFoliagePlacer(0, 0)).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.02f))).build();
    public static final BranchedTreeFeatureConfig BIRCH_TREE_WITH_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BIRCH_LOG), new SimpleBlockStateProvider(BIRCH_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(5).heightRandA(2).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.02f))).build();
    public static final BranchedTreeFeatureConfig BIRCH_TREE_WITH_MORE_BEEHIVES_CONFIG = new BranchedTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BIRCH_LOG), new SimpleBlockStateProvider(BIRCH_LEAVES), new BlobFoliagePlacer(2, 0)).baseHeight(5).heightRandA(2).foliageHeight(3).noVines().treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new BeehiveTreeDecorator(0.05f))).build();
    ...
    public static final MegaTreeFeatureConfig MEGA_SPRUCE_TREE_CONFIG = new MegaTreeFeatureConfig.Builder(new SimpleBlockStateProvider(SPRUCE_LOG), new SimpleBlockStateProvider(SPRUCE_LEAVES)).baseHeight(13).heightInterval(15).crownHeight(13).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new AlterGroundTreeDecorator(new SimpleBlockStateProvider(PODZOL)))).build();
    public static final MegaTreeFeatureConfig MEGA_PINE_TREE_CONFIG = new MegaTreeFeatureConfig.Builder(new SimpleBlockStateProvider(SPRUCE_LOG), new SimpleBlockStateProvider(SPRUCE_LEAVES)).baseHeight(13).heightInterval(15).crownHeight(3).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new AlterGroundTreeDecorator(new SimpleBlockStateProvider(PODZOL)))).build();
    public static final MegaTreeFeatureConfig MEGA_JUNGLE_TREE_CONFIG = new MegaTreeFeatureConfig.Builder(new SimpleBlockStateProvider(JUNGLE_LOG), new SimpleBlockStateProvider(JUNGLE_LEAVES)).baseHeight(10).heightInterval(20).treeDecorators((List<TreeDecorator>)ImmutableList.of((Object)new TrunkVineTreeDecorator(), (Object)new LeaveVineTreeDecorator())).build();
    ...
    public static final SpringFeatureConfig WATER_SPRING_CONFIG = new SpringFeatureConfig(Fluids.WATER.getDefaultState(), true, 4, 1, (Set<Block>)ImmutableSet.of((Object)Blocks.STONE, (Object)Blocks.GRANITE, (Object)Blocks.DIORITE, (Object)Blocks.ANDESITE));
    public static final SpringFeatureConfig LAVA_SPRING_CONFIG = new SpringFeatureConfig(Fluids.LAVA.getDefaultState(), true, 4, 1, (Set<Block>)ImmutableSet.of((Object)Blocks.STONE, (Object)Blocks.GRANITE, (Object)Blocks.DIORITE, (Object)Blocks.ANDESITE));
    public static final SpringFeatureConfig NETHER_SPRING_CONFIG = new SpringFeatureConfig(Fluids.LAVA.getDefaultState(), false, 4, 1, (Set<Block>)ImmutableSet.of((Object)Blocks.NETHERRACK));
    public static final SpringFeatureConfig ENCLOSED_NETHER_SPRING_CONFIG = new SpringFeatureConfig(Fluids.LAVA.getDefaultState(), false, 5, 0, (Set<Block>)ImmutableSet.of((Object)Blocks.NETHERRACK));
    ...
    public static void addDefaultDisks(Biome biome) {
        biome.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, Feature.DISK.configure(new DiskFeatureConfig(SAND, 7, 2, Lists.newArrayList((Object[])new BlockState[]{DIRT, GRASS_BLOCK}))).createDecoratedFeature(Decorator.COUNT_TOP_SOLID.configure(new CountDecoratorConfig(3))));
        biome.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, Feature.DISK.configure(new DiskFeatureConfig(CLAY, 4, 1, Lists.newArrayList((Object[])new BlockState[]{DIRT, CLAY}))).createDecoratedFeature(Decorator.COUNT_TOP_SOLID.configure(new CountDecoratorConfig(1))));
        biome.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, Feature.DISK.configure(new DiskFeatureConfig(GRAVEL, 6, 2, Lists.newArrayList((Object[])new BlockState[]{DIRT, GRASS_BLOCK}))).createDecoratedFeature(Decorator.COUNT_TOP_SOLID.configure(new CountDecoratorConfig(1))));
    }
    ...
    public static void addMountainTrees(Biome biome) {
        biome.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig((List<RandomFeatureEntry<?>>)ImmutableList.of(Feature.NORMAL_TREE.configure(SPRUCE_TREE_CONFIG).withChance(0.666f), Feature.FANCY_TREE.configure(FANCY_TREE_CONFIG).withChance(0.1f)), Feature.NORMAL_TREE.configure(OAK_TREE_CONFIG))).createDecoratedFeature(Decorator.COUNT_EXTRA_HEIGHTMAP.configure(new CountExtraChanceDecoratorConfig(0, 0.1f, 1))));
    }
    ...
    public static void addJungleTrees(Biome biome) {
        biome.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig((List<RandomFeatureEntry<?>>)ImmutableList.of(Feature.FANCY_TREE.configure(FANCY_TREE_CONFIG).withChance(0.1f), Feature.JUNGLE_GROUND_BUSH.configure(JUNGLE_GROUND_BUSH_CONFIG).withChance(0.5f), Feature.MEGA_JUNGLE_TREE.configure(MEGA_JUNGLE_TREE_CONFIG).withChance(0.33333334f)), Feature.NORMAL_TREE.configure(JUNGLE_TREE_CONFIG))).createDecoratedFeature(Decorator.COUNT_EXTRA_HEIGHTMAP.configure(new CountExtraChanceDecoratorConfig(50, 0.1f, 1))));
    }
    ...
    public static void addPlainsFeatures(Biome biome) {
        biome.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig((List<RandomFeatureEntry<?>>)ImmutableList.of(Feature.FANCY_TREE.configure(FANCY_TREE_WITH_MORE_BEEHIVES_CONFIG).withChance(0.33333334f)), Feature.NORMAL_TREE.configure(OAK_TREE_WITH_MORE_BEEHIVES_CONFIG))).createDecoratedFeature(Decorator.COUNT_EXTRA_HEIGHTMAP.configure(new CountExtraChanceDecoratorConfig(0, 0.05f, 1))));
