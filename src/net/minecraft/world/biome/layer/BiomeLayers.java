...
implements BiomeIds {
    ...
    extends Enum<Category> {
        public static final /* enum */ Category NONE = new Category();
        public static final /* enum */ Category TAIGA = new Category();
        public static final /* enum */ Category EXTREME_HILLS = new Category();
        public static final /* enum */ Category JUNGLE = new Category();
        public static final /* enum */ Category MESA = new Category();
        public static final /* enum */ Category BADLANDS_PLATEAU = new Category();
        public static final /* enum */ Category PLAINS = new Category();
        public static final /* enum */ Category SAVANNA = new Category();
        public static final /* enum */ Category ICY = new Category();
        public static final /* enum */ Category BEACH = new Category();
        public static final /* enum */ Category FOREST = new Category();
        public static final /* enum */ Category OCEAN = new Category();
        public static final /* enum */ Category DESERT = new Category();
        public static final /* enum */ Category RIVER = new Category();
        public static final /* enum */ Category SWAMP = new Category();
        public static final /* enum */ Category MUSHROOM = new Category();
        private static final /* synthetic */ Category[] field_26726;

        public static Category[] values() {
            return (Category[])field_26726.clone();
        }
        ...
        private static /* synthetic */ Category[] method_36775() {
            return new Category[]{NONE, TAIGA, EXTREME_HILLS, JUNGLE, MESA, BADLANDS_PLATEAU, PLAINS, SAVANNA, ICY, BEACH, FOREST, OCEAN, DESERT, RIVER, SWAMP, MUSHROOM};
        }

        static {
            field_26726 = Category.method_36775();
        }
    }
}
