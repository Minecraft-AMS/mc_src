...
public final class VoronoiBiomeAccessType
extends Enum<VoronoiBiomeAccessType>
implements BiomeAccessType {
    public static final /* enum */ VoronoiBiomeAccessType INSTANCE = new VoronoiBiomeAccessType();
    private static final int field_30979 = 2;
    private static final int field_30980 = 4;
    private static final int field_30981 = 3;
    private static final /* synthetic */ VoronoiBiomeAccessType[] field_20645;

    public static VoronoiBiomeAccessType[] values() {
        return (VoronoiBiomeAccessType[])field_20645.clone();
    }

    public static VoronoiBiomeAccessType valueOf(String string) {
        return Enum.valueOf(VoronoiBiomeAccessType.class, string);
    }
    ...
    private static /* synthetic */ VoronoiBiomeAccessType[] method_36702() {
        return new VoronoiBiomeAccessType[]{INSTANCE};
    }

    static {
        field_20645 = VoronoiBiomeAccessType.method_36702();
    }
}
