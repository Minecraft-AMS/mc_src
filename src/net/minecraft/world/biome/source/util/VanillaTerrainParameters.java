...
public record VanillaTerrainParameters(Spline<NoisePoint> offsetSpline, Spline<NoisePoint> factorSpline, Spline<NoisePoint> peakSpline) {
    ...
    public static final Codec<VanillaTerrainParameters> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)field_35457.fieldOf("offset").forGetter(VanillaTerrainParameters::offsetSpline), (App)field_35457.fieldOf("factor").forGetter(VanillaTerrainParameters::factorSpline), (App)field_35457.fieldOf("jaggedness").forGetter(vanillaTerrainParameters -> vanillaTerrainParameters.peakSpline)).apply((Applicative)instance, VanillaTerrainParameters::new));
    ...
    public void writeDebugBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters) {
        ...
        parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(parameterRange, parameterRange, parameterRange, parameterRange, MultiNoiseUtil.ParameterRange.of(0.0f), parameterRange, 0.01f), BiomeKeys.PLAINS));
        ...
        for (n = 0; n < n2; ++n) {
            ...
            parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(parameterRange, parameterRange, parameterRange, MultiNoiseUtil.ParameterRange.of(float_.floatValue()), MultiNoiseUtil.ParameterRange.of(0.0f), parameterRange, 0.0f), registryKey));
        ...
        for (n = 0; n < n2; ++n) {
            float_ = Float.valueOf(fArray[n]);
            parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(parameterRange, parameterRange, MultiNoiseUtil.ParameterRange.of(float_.floatValue()), parameterRange, MultiNoiseUtil.ParameterRange.of(0.0f), parameterRange, 0.0f), BiomeKeys.SNOWY_TAIGA));
        }
    }
    ...
    public final String toString() {
        return ObjectMethods.bootstrap("toString", new MethodHandle[]{VanillaTerrainParameters.class, "offsetSampler;factorSampler;jaggednessSampler", "offsetSpline", "factorSpline", "peakSpline"}, this);
    }

    @Override
    public final int hashCode() {
        return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{VanillaTerrainParameters.class, "offsetSampler;factorSampler;jaggednessSampler", "offsetSpline", "factorSpline", "peakSpline"}, this);
    }

    @Override
    public final boolean equals(Object object) {
        return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{VanillaTerrainParameters.class, "offsetSampler;factorSampler;jaggednessSampler", "offsetSpline", "factorSpline", "peakSpline"}, this, object);
    }

    @VisibleForTesting
    protected static final class LocationFunction
    extends Enum<LocationFunction>
    implements StringIdentifiable,
    ToFloatFunction<NoisePoint> {
        public static final /* enum */ LocationFunction CONTINENTS = new LocationFunction(NoisePoint::continentalnessNoise, "continents");
        public static final /* enum */ LocationFunction EROSION = new LocationFunction(NoisePoint::erosionNoise, "erosion");
        public static final /* enum */ LocationFunction WEIRDNESS = new LocationFunction(NoisePoint::weirdnessNoise, "weirdness");
        @Deprecated
        public static final /* enum */ LocationFunction RIDGES = new LocationFunction(NoisePoint::normalizedWeirdness, "ridges");
        ...
        private static final /* synthetic */ LocationFunction[] field_35467;

        public static LocationFunction[] values() {
            return (LocationFunction[])field_35467.clone();
        }

        public static LocationFunction valueOf(String string) {
            return Enum.valueOf(LocationFunction.class, string);
        }
        ...
        private static /* synthetic */ LocationFunction[] method_39289() {
            return new LocationFunction[]{CONTINENTS, EROSION, WEIRDNESS, RIDGES};
        }

        static {
            field_35467 = LocationFunction.method_39289();
            ...
            field_35464 = CODEC.flatComapMap(locationFunction -> locationFunction, toFloatFunction -> {
                ...
                if (toFloatFunction instanceof LocationFunction) {
                    ...
                    dataResult = DataResult.success((Object)locationFunction);
                } else {
    ...
    public record NoisePoint(float continentalnessNoise, float erosionNoise, float normalizedWeirdness, float weirdnessNoise) {
        @Override
        public final String toString() {
            return ObjectMethods.bootstrap("toString", new MethodHandle[]{NoisePoint.class, "continents;erosion;ridges;weirdness", "continentalnessNoise", "erosionNoise", "normalizedWeirdness", "weirdnessNoise"}, this);
        }

        @Override
        public final int hashCode() {
            return (int)ObjectMethods.bootstrap("hashCode", new MethodHandle[]{NoisePoint.class, "continents;erosion;ridges;weirdness", "continentalnessNoise", "erosionNoise", "normalizedWeirdness", "weirdnessNoise"}, this);
        }

        @Override
        public final boolean equals(Object object) {
            return (boolean)ObjectMethods.bootstrap("equals", new MethodHandle[]{NoisePoint.class, "continents;erosion;ridges;weirdness", "continentalnessNoise", "erosionNoise", "normalizedWeirdness", "weirdnessNoise"}, this, object);
        }
    }
