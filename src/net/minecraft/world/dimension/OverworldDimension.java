...
extends Dimension {
    ...
    public ChunkGenerator<? extends ChunkGeneratorConfig> createChunkGenerator() {
        ...
        if (levelGeneratorType == LevelGeneratorType.FLAT) {
            FlatChunkGeneratorConfig flatChunkGeneratorConfig = FlatChunkGeneratorConfig.fromDynamic(new Dynamic((DynamicOps)NbtOps.INSTANCE, (Object)this.world.getLevelProperties().getGeneratorOptions()));
        ...
        if (levelGeneratorType == LevelGeneratorType.BUFFET) {
            ...
            JsonElement jsonElement = (JsonElement)Dynamic.convert((DynamicOps)NbtOps.INSTANCE, (DynamicOps)JsonOps.INSTANCE, (Object)this.world.getLevelProperties().getGeneratorOptions());
