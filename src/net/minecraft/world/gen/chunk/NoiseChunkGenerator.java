...
extends ChunkGenerator {
    ...
    public void populateNoise(WorldAccess world, StructureAccessor accessor, Chunk chunk) {
        ...
        for (StructureFeature<?> structureFeature : StructureFeature.JIGSAW_STRUCTURES) {
            accessor.getStructuresWithChildren(ChunkSectionPos.from(chunkPos, 0), structureFeature).forEach(arg_0 -> NoiseChunkGenerator.method_26983(chunkPos, (ObjectList)objectList, k, l, (ObjectList)objectList2, arg_0));
        }
    ...
    private static /* synthetic */ void method_26983(ChunkPos chunkPos, ObjectList objectList, int i, int j, ObjectList objectList2, StructureStart start) {
