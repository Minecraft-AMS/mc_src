...
implements BlockPredicate {
    public static final Codec<InsideWorldBoundsBlockPredicate> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Vec3i.createOffsetCodec(16).optionalFieldOf("offset", (Object)BlockPos.ORIGIN).forGetter(predicate -> predicate.offset)).apply((Applicative)instance, InsideWorldBoundsBlockPredicate::new));
