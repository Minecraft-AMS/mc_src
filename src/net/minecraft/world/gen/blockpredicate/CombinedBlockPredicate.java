...
implements BlockPredicate {
    ...
    public static <T extends CombinedBlockPredicate> Codec<T> buildCodec(Function<List<BlockPredicate>, T> combiner) {
        return RecordCodecBuilder.create(instance -> instance.group((App)BlockPredicate.BASE_CODEC.listOf().fieldOf("predicates").forGetter(predicate -> predicate.predicates)).apply((Applicative)instance, combiner));
    }
}
