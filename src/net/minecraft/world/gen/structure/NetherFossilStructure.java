...
extends Structure {
    public static final Codec<NetherFossilStructure> CODEC = RecordCodecBuilder.create(instance -> instance.group(NetherFossilStructure.configCodecBuilder(instance), (App)HeightProvider.CODEC.fieldOf("height").forGetter(structure -> structure.height)).apply((Applicative)instance, NetherFossilStructure::new));
