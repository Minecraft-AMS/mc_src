...
extends TreeDecorator {
    ...
    public <T> T serialize(DynamicOps<T> ops) {
        return (T)new Dynamic(ops, ops.createMap((Map)ImmutableMap.of((Object)ops.createString("type"), (Object)ops.createString(Registry.TREE_DECORATOR_TYPE.getId(this.type).toString()), (Object)ops.createString("provider"), this.field_21316.serialize(ops)))).getValue();
    }
}
