...
implements FeatureConfig {
    ...
    public static final Codec<GeodeFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)GeodeLayerConfig.CODEC.fieldOf("blocks").forGetter(geodeFeatureConfig -> geodeFeatureConfig.layerConfig), (App)GeodeLayerThicknessConfig.CODEC.fieldOf("layers").forGetter(geodeFeatureConfig -> geodeFeatureConfig.layerThicknessConfig), (App)GeodeCrackConfig.CODEC.fieldOf("crack").forGetter(geodeFeatureConfig -> geodeFeatureConfig.crackConfig), (App)RANGE.fieldOf("use_potential_placements_chance").orElse((Object)0.35).forGetter(geodeFeatureConfig -> geodeFeatureConfig.usePotentialPlacementsChance), (App)RANGE.fieldOf("use_alternate_layer0_chance").orElse((Object)0.0).forGetter(geodeFeatureConfig -> geodeFeatureConfig.useAlternateLayer0Chance), (App)Codec.BOOL.fieldOf("placements_require_layer0_alternate").orElse((Object)true).forGetter(geodeFeatureConfig -> geodeFeatureConfig.placementsRequireLayer0Alternate), (App)IntProvider.createValidatingCodec(1, 20).fieldOf("outer_wall_distance").orElse((Object)UniformIntProvider.create(4, 5)).forGetter(geodeFeatureConfig -> geodeFeatureConfig.outerWallDistance), (App)IntProvider.createValidatingCodec(1, 20).fieldOf("distribution_points").orElse((Object)UniformIntProvider.create(3, 4)).forGetter(geodeFeatureConfig -> geodeFeatureConfig.distributionPoints), (App)IntProvider.createValidatingCodec(0, 10).fieldOf("point_offset").orElse((Object)UniformIntProvider.create(1, 2)).forGetter(geodeFeatureConfig -> geodeFeatureConfig.pointOffset), (App)Codec.INT.fieldOf("min_gen_offset").orElse((Object)-16).forGetter(geodeFeatureConfig -> geodeFeatureConfig.minGenOffset), (App)Codec.INT.fieldOf("max_gen_offset").orElse((Object)16).forGetter(geodeFeatureConfig -> geodeFeatureConfig.maxGenOffset), (App)RANGE.fieldOf("noise_multiplier").orElse((Object)0.05).forGetter(geodeFeatureConfig -> geodeFeatureConfig.noiseMultiplier), (App)Codec.INT.fieldOf("invalid_blocks_threshold").forGetter(geodeFeatureConfig -> geodeFeatureConfig.invalidBlocksThreshold)).apply((Applicative)instance, GeodeFeatureConfig::new));
