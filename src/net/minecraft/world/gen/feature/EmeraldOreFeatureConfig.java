...
implements FeatureConfig {
    public static final Codec<EmeraldOreFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.list(OreFeatureConfig.Target.CODEC).fieldOf("targets").forGetter(emeraldOreFeatureConfig -> emeraldOreFeatureConfig.target)).apply((Applicative)instance, EmeraldOreFeatureConfig::new));
