...
implements Decoratable<ConfiguredFeature<?, ?>> {
    ...
    public String toString() {
        return BuiltinRegistries.CONFIGURED_FEATURE.getKey(this).map(Objects::toString).orElseGet(() -> CODEC.encodeStart((DynamicOps)JsonOps.INSTANCE, (Object)this).toString());
    }
