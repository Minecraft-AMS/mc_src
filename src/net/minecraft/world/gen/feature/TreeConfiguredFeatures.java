...
public class TreeConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> JUNGLE_TREE = ConfiguredFeatures.register("jungle_tree", Feature.TREE, TreeConfiguredFeatures.jungle().decorators((List<TreeDecorator>)ImmutableList.of((Object)new CocoaBeansTreeDecorator(0.2f), (Object)TrunkVineTreeDecorator.INSTANCE, (Object)new LeavesVineTreeDecorator(0.25f))).ignoreVines().build());
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> SWAMP_OAK = ConfiguredFeatures.register("swamp_oak", Feature.TREE, TreeConfiguredFeatures.builder(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators((List<TreeDecorator>)ImmutableList.of((Object)new LeavesVineTreeDecorator(0.25f))).build());
