...
public class TreeConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, JUNGLE_TREE, Feature.TREE, TreeConfiguredFeatures.jungle().decorators((List<TreeDecorator>)ImmutableList.of((Object)new CocoaBeansTreeDecorator(0.2f), (Object)TrunkVineTreeDecorator.INSTANCE, (Object)new LeavesVineTreeDecorator(0.25f))).ignoreVines().build());
