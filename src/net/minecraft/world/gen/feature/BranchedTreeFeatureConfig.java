...
extends TreeFeatureConfig {
    ...
    public <T> Dynamic<T> serialize(DynamicOps<T> ops) {
        ...
        Dynamic dynamic = new Dynamic(ops, ops.createMap((Map)builder.build()));
    ...
    public static <T> BranchedTreeFeatureConfig deserialize(Dynamic<T> dynamic) {
        ...
        FoliagePlacerType<?> foliagePlacerType = Registry.FOLIAGE_PLACER_TYPE.get(new Identifier((String)dynamic.get("foliage_placer").get("type").asString().orElseThrow(RuntimeException::new)));
