...
extends CarverConfig {
    public static final Codec<CaveCarverConfig> CAVE_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)CarverConfig.CONFIG_CODEC.forGetter(caveCarverConfig -> caveCarverConfig), (App)FloatProvider.VALUE_CODEC.fieldOf("horizontal_radius_multiplier").forGetter(caveCarverConfig -> caveCarverConfig.horizontalRadiusMultiplier), (App)FloatProvider.VALUE_CODEC.fieldOf("vertical_radius_multiplier").forGetter(caveCarverConfig -> caveCarverConfig.verticalRadiusMultiplier), (App)FloatProvider.createValidatedCodec(-1.0f, 1.0f).fieldOf("floor_level").forGetter(caveCarverConfig -> caveCarverConfig.floorLevel)).apply((Applicative)instance, CaveCarverConfig::new));
