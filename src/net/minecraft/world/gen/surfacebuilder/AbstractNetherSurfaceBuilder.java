...
extends SurfaceBuilder<TernarySurfaceConfig> {
    ...
    public void initSeed(long seed) {
        if (this.seed != seed || this.shoreNoise == null || this.surfaceNoises.isEmpty() || this.underLavaNoises.isEmpty()) {
            ...
            this.shoreNoise = new OctavePerlinNoiseSampler((WorldGenRandom)new ChunkRandom(seed + (long)this.surfaceNoises.size() + (long)this.underLavaNoises.size()), (List<Integer>)ImmutableList.of((Object)0));
        }
        this.seed = seed;
    }
    ...
    private static ImmutableMap<BlockState, OctavePerlinNoiseSampler> createNoisesForStates(ImmutableList<BlockState> states, long seed) {
        ...
        for (BlockState blockState : states) {
            builder.put((Object)blockState, (Object)new OctavePerlinNoiseSampler((WorldGenRandom)new ChunkRandom(seed), (List<Integer>)ImmutableList.of((Object)-4)));
            ++seed;
        }
