...
public class FlatLevelGeneratorPresets {
    ...
    static class Registrar {
        ...
        public RegistryEntry<FlatLevelGeneratorPreset> initAndGetDefault() {
            ...
            return this.createAndRegister(THE_VOID, Blocks.BARRIER, BiomeKeys.THE_VOID, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(), true, false, new FlatChunkGeneratorLayer(1, Blocks.AIR));
        }
    }
}
