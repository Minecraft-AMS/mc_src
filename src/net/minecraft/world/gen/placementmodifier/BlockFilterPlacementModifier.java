...
extends AbstractConditionalPlacementModifier {
    public static final Codec<BlockFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)BlockPredicate.BASE_CODEC.fieldOf("predicate").forGetter(blockFilterPlacementModifier -> blockFilterPlacementModifier.predicate)).apply((Applicative)instance, BlockFilterPlacementModifier::new));
