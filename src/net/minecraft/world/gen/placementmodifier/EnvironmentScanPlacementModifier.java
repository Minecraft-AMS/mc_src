...
extends PlacementModifier {
    ...
    public static final Codec<EnvironmentScanPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Direction.VERTICAL_CODEC.fieldOf("direction_of_search").forGetter(environmentScanPlacementModifier -> environmentScanPlacementModifier.direction), (App)BlockPredicate.BASE_CODEC.fieldOf("target_condition").forGetter(environmentScanPlacementModifier -> environmentScanPlacementModifier.targetPredicate), (App)BlockPredicate.BASE_CODEC.optionalFieldOf("allowed_search_condition", (Object)BlockPredicate.alwaysTrue()).forGetter(environmentScanPlacementModifier -> environmentScanPlacementModifier.allowedSearchPredicate), (App)Codec.intRange((int)1, (int)32).fieldOf("max_steps").forGetter(environmentScanPlacementModifier -> environmentScanPlacementModifier.maxSteps)).apply((Applicative)instance, EnvironmentScanPlacementModifier::new));
