...
public class ChunkStatus {
    ...
    private static ChunkStatus register(String id, @Nullable ChunkStatus previous, int taskMargin, EnumSet<Heightmap.Type> heightMapTypes, ChunkType chunkType, Task task) {
        return ChunkStatus.method_20611(id, previous, taskMargin, heightMapTypes, chunkType, task, field_19345);
    }
    ...
    ChunkStatus(String id, @Nullable ChunkStatus previous, int taskMargin, EnumSet<Heightmap.Type> heightMapTypes, ChunkType chunkType, Task task, class_4305 arg) {
        this.id = id;
