...
public final class BelowZeroRetrogen {
    ...
    private static final Codec<ChunkStatus> STATUS_CODEC = Registry.CHUNK_STATUS.getCodec().comapFlatMap(chunkStatus -> chunkStatus == ChunkStatus.EMPTY ? DataResult.error((String)"target_status cannot be empty") : DataResult.success((Object)chunkStatus), Function.identity());
