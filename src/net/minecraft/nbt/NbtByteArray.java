...
extends AbstractNbtList<NbtByte> {
    ...
    public void method_10531(int i, NbtByte nbtByte) {
        this.value = ArrayUtils.add((byte[])this.value, (int)i, (byte)nbtByte.byteValue());
    }
    ...
    public boolean addElement(int index, NbtElement element) {
        if (element instanceof AbstractNbtNumber) {
            this.value = ArrayUtils.add((byte[])this.value, (int)index, (byte)((AbstractNbtNumber)element).byteValue());
            return true;
        }
        return false;
    }
