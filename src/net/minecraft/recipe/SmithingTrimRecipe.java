...
implements SmithingRecipe {
    ...
    implements RecipeSerializer<SmithingTrimRecipe> {
        ...
        public SmithingTrimRecipe read(Identifier identifier, JsonObject jsonObject) {
            Ingredient ingredient = Ingredient.fromJson((JsonElement)JsonHelper.getObject(jsonObject, "template"));
            Ingredient ingredient2 = Ingredient.fromJson((JsonElement)JsonHelper.getObject(jsonObject, "base"));
            Ingredient ingredient3 = Ingredient.fromJson((JsonElement)JsonHelper.getObject(jsonObject, "addition"));
