...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<Advancement> exporter) {
        ...
        VanillaHusbandryTabAdvancementGenerator.requireFoodItemsEaten(Advancement.Builder.create()).parent(advancement2).display(Items.APPLE, (Text)Text.translatable("advancements.husbandry.balanced_diet.title"), (Text)Text.translatable("advancements.husbandry.balanced_diet.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(exporter, "husbandry/balanced_diet");
        ...
        VanillaHusbandryTabAdvancementGenerator.requireAllCatsTamed(Advancement.Builder.create()).parent(advancement4).display(Items.COD, (Text)Text.translatable("advancements.husbandry.complete_catalogue.title"), (Text)Text.translatable("advancements.husbandry.complete_catalogue.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(exporter, "husbandry/complete_catalogue");
        ...
        Advancement advancement11 = VanillaHusbandryTabAdvancementGenerator.requireAllFrogsOnLeads(Advancement.Builder.create()).parent(advancement10).display(Items.LEAD, (Text)Text.translatable("advancements.husbandry.leash_all_frog_variants.title"), (Text)Text.translatable("advancements.husbandry.leash_all_frog_variants.description"), null, AdvancementFrame.TASK, true, true, false).build(exporter, "husbandry/leash_all_frog_variants");
        ...
        Advancement advancement13 = Advancement.Builder.create().parent(advancement).display(Items.SNIFFER_EGG, (Text)Text.translatable("advancements.husbandry.obtain_sniffer_egg.title"), (Text)Text.translatable("advancements.husbandry.obtain_sniffer_egg.description"), null, AdvancementFrame.TASK, true, true, true).criterion("obtain_sniffer_egg", InventoryChangedCriterion.Conditions.items(Items.SNIFFER_EGG)).build(exporter, "husbandry/obtain_sniffer_egg");
        Advancement advancement14 = Advancement.Builder.create().parent(advancement13).display(Items.TORCHFLOWER_SEEDS, (Text)Text.translatable("advancements.husbandry.feed_snifflet.title"), (Text)Text.translatable("advancements.husbandry.feed_snifflet.description"), null, AdvancementFrame.TASK, true, true, true).criterion("feed_snifflet", PlayerInteractedWithEntityCriterion.Conditions.create(ItemPredicate.Builder.create().tag(ItemTags.SNIFFER_FOOD), EntityPredicate.Extended.ofLegacy(EntityPredicate.Builder.create().type(EntityType.SNIFFER).flags(EntityFlagsPredicate.Builder.create().isBaby(true).build()).build()))).build(exporter, "husbandry/feed_snifflet");
        Advancement.Builder.create().parent(advancement14).display(Items.PITCHER_POD, (Text)Text.translatable("advancements.husbandry.plant_any_sniffer_seed.title"), (Text)Text.translatable("advancements.husbandry.plant_any_sniffer_seed.description"), null, AdvancementFrame.TASK, true, true, true).criteriaMerger(CriterionMerger.OR).criterion("torchflower", PlacedBlockCriterion.Conditions.block(Blocks.TORCHFLOWER_CROP)).criterion("pitcher_pod", PlacedBlockCriterion.Conditions.block(Blocks.PITCHER_CROP)).build(exporter, "husbandry/plant_any_sniffer_seed");
    }
