...
implements BuiltInExceptionProvider {
    ...
    private static final SimpleCommandExceptionType READER_EXPECTED_START_QUOTE = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.quote.expected.start", new Object[0]));
    private static final SimpleCommandExceptionType READER_EXPECTED_END_QUOTE = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.quote.expected.end", new Object[0]));
    ...
    private static final SimpleCommandExceptionType READER_EXPECTED_INT = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.int.expected", new Object[0]));
    ...
    private static final SimpleCommandExceptionType READER_EXPECTED_LONG = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.long.expected", new Object[0]));
    ...
    private static final SimpleCommandExceptionType READER_EXPECTED_DOUBLE = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.double.expected", new Object[0]));
    ...
    private static final SimpleCommandExceptionType READER_EXPECTED_FLOAT = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.float.expected", new Object[0]));
    private static final SimpleCommandExceptionType READER_EXPECTED_BOOL = new SimpleCommandExceptionType((Message)new TranslatableText("parsing.bool.expected", new Object[0]));
    ...
    private static final SimpleCommandExceptionType DISPATCHER_UNKNOWN_COMMAND = new SimpleCommandExceptionType((Message)new TranslatableText("command.unknown.command", new Object[0]));
    private static final SimpleCommandExceptionType DISPATCHER_UNKNOWN_ARGUMENT = new SimpleCommandExceptionType((Message)new TranslatableText("command.unknown.argument", new Object[0]));
    private static final SimpleCommandExceptionType DISPATCHER_EXPECTED_ARGUMENT_SEPARATOR = new SimpleCommandExceptionType((Message)new TranslatableText("command.expected.separator", new Object[0]));
