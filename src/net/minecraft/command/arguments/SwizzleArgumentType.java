...
implements ArgumentType<EnumSet<Direction.Axis>> {
    ...
    private static final SimpleCommandExceptionType INVALID_SWIZZLE_EXCEPTION = new SimpleCommandExceptionType((Message)new TranslatableText("arguments.swizzle.invalid", new Object[0]));
