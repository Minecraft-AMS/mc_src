...
implements ArgumentType<PosArgument> {
    ...
    public static final SimpleCommandExceptionType UNLOADED_EXCEPTION = new SimpleCommandExceptionType((Message)new TranslatableText("argument.pos.unloaded", new Object[0]));
    public static final SimpleCommandExceptionType OUT_OF_WORLD_EXCEPTION = new SimpleCommandExceptionType((Message)new TranslatableText("argument.pos.outofworld", new Object[0]));
    ...
    public static BlockPos getLoadedBlockPos(CommandContext<ServerCommandSource> context, String name) throws CommandSyntaxException {
        ...
        if (!((ServerCommandSource)context.getSource()).getWorld().isBlockLoaded(blockPos)) {
