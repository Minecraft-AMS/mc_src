...
implements ArgumentType<ParticleEffect> {
    ...
    public static ParticleEffect readParameters(StringReader reader) throws CommandSyntaxException {
        ...
        ParticleType<? extends ParticleEffect> particleType = Registry.PARTICLE_TYPE.getOrEmpty(identifier).orElseThrow(() -> UNKNOWN_PARTICLE_EXCEPTION.create((Object)identifier));
