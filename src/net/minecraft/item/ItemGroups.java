...
public class ItemGroups {
    ...
    public static ItemGroup registerAndGetDefault(Registry<ItemGroup> registry) {
        ...
        return Registry.register(registry, INVENTORY, ItemGroup.create(ItemGroup.Row.BOTTOM, 6).displayName(Text.translatable("itemGroup.inventory")).icon(() -> new ItemStack(Blocks.CHEST)).texture("inventory.png").noRenderedName().special().type(ItemGroup.Type.INVENTORY).noScrollbar().build());
    }
