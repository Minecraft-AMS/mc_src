...
implements EntryCombiner {
    ...
    implements JsonSerializer<T> {
        ...
        public final void toJson(JsonObject jsonObject, T lootPoolEntry, JsonSerializationContext jsonSerializationContext) {
            if (!ArrayUtils.isEmpty((Object[])((LootPoolEntry)lootPoolEntry).conditions)) {
                jsonObject.add("conditions", jsonSerializationContext.serialize((Object)((LootPoolEntry)lootPoolEntry).conditions));
            }
