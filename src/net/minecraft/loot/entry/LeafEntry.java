    ...
    extends LootPoolEntry.Serializer<T> {
        ...
        public void addEntryFields(JsonObject jsonObject, T leafEntry, JsonSerializationContext jsonSerializationContext) {
            ...
            if (((LeafEntry)leafEntry).quality != 0) {
                jsonObject.addProperty("quality", (Number)((LeafEntry)leafEntry).quality);
            }
            if (!ArrayUtils.isEmpty((Object[])((LeafEntry)leafEntry).functions)) {
                jsonObject.add("functions", jsonSerializationContext.serialize((Object)((LeafEntry)leafEntry).functions));
            }
        }
