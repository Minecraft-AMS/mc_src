...
extends ConditionalLootFunction {
    ...
    public Set<LootContextParameter<?>> getRequiredParameters() {
        return (Set)this.effects.values().stream().flatMap(numberProvider -> numberProvider.getRequiredParameters().stream()).collect(ImmutableSet.toImmutableSet());
    }
        ...
        public void toJson(JsonObject jsonObject, SetStewEffectLootFunction setStewEffectLootFunction, JsonSerializationContext jsonSerializationContext) {
            ...
            if (!setStewEffectLootFunction.effects.isEmpty()) {
                ...
                for (StatusEffect statusEffect : setStewEffectLootFunction.effects.keySet()) {
                    ...
                    jsonObject2.add("duration", jsonSerializationContext.serialize((Object)setStewEffectLootFunction.effects.get(statusEffect)));
