...
extends DataFix {
    ...
    private TypeRewriteRule renameObjectives() {
        ...
        return this.fixTypeEverywhereTyped(this.name, type2, type, typed -> typed.updateTyped(opticFinder, typed2 -> typed2.updateTyped(opticFinder2, typed -> typed.update(opticFinder3, old -> this.replacements.getOrDefault(old, (String)old)))));
    }
