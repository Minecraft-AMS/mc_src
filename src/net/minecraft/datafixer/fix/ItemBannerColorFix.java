            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:banner")) {
                ...
                if (optional2.isPresent() && (optional3 = (typed2 = (Typed)optional2.get()).getOptionalTyped(opticFinder3)).isPresent()) {
                    ...
                    if (dynamic3.get("Base").asNumber().isPresent()) {
                        ...
                        if (optional4.isPresent() && Objects.equals(dynamic4 = (Dynamic)optional4.get(), dynamic4.emptyMap().merge(dynamic4.createString("Lore"), dynamic4.createList(Stream.of(dynamic4.createString("(+NBT")))))) {
