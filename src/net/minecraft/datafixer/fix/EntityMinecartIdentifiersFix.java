    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhere("EntityMinecartIdentifiersFix", (Type)taggedChoiceType, (Type)taggedChoiceType2, dynamicOps -> pair -> {
            if (Objects.equals(pair.getFirst(), "Minecart")) {
                ...
                return Pair.of((Object)string, (Object)((DataResult)typed.write().map(dynamic -> ((Type)taggedChoiceType2.types().get(string)).read(dynamic)).result().orElseThrow(() -> new IllegalStateException("Could not read the new minecart."))));
            }
            return pair;
        });
    }
