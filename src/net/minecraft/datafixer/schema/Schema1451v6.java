...
extends IdentifierNormalizingSchema {
    ...
    protected static final Hook.HookFunction field_34014 = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> dynamicOps, T object) {
            ...
            return (T)((Dynamic)DataFixUtils.orElse(dynamic.get("CriteriaName").asString().get().left().map(string -> {
                int i = string.indexOf(58);
                if (i < 0) {
                    return Pair.of((Object)Schema1451v6.field_34013, (Object)string);
                }
                try {
    ...
    protected static final Hook.HookFunction field_34015 = new Hook.HookFunction(){
        ...
        public <T> T apply(DynamicOps<T> dynamicOps, T object) {
            ...
            Optional<Dynamic> optional = dynamic.get("CriteriaType").get().get().left().flatMap(dynamic2 -> {
                Optional optional = dynamic2.get("type").asString().get().left();
                Optional optional2 = dynamic2.get("id").asString().get().left();
                if (optional.isPresent() && optional2.isPresent()) {
                    ...
                    return Optional.of(dynamic2.createString(this.method_37399(string) + ":" + this.method_37399((String)optional2.get())));
                }
    ...
    protected static Map<String, Supplier<TypeTemplate>> method_37389(Schema schema) {
        ...
        map.put(field_34013, () -> DSL.optionalFields((String)"id", (TypeTemplate)DSL.constType((Type)DSL.string())));
        return map;
    }
}
