...
public class Schemas {
    ...
    private static synchronized DataFixer create(Set<DSL.TypeReference> requiredTypes) {
        ...
        return dataFixerBuilder.buildOptimized(requiredTypes, (Executor)executor);
    }
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer((DataFix)new EntityEquipmentToArmorAndHandFix(schema, true));
        Schema schema2 = builder.addSchema(101, EMPTY);
        builder.addFixer((DataFix)new BlockEntitySignTextStrictJsonFix(schema2, false));
        ...
        builder.addFixer((DataFix)new EntityMinecartIdentifiersFix(schema6, true));
        ...
        builder.addFixer((DataFix)new ItemWrittenBookPagesStrictJsonFix(schema15, true));
        ...
        builder.addFixer((DataFix)new EntityZombieSplitFix(schema21, true));
        ...
        builder.addFixer((DataFix)new WriteAndReadFix(schema43, "Rewrite objectives", TypeReferences.OBJECTIVE));
        ...
        builder.addFixer((DataFix)new VillagerTradeFix(schema44, false));
        ...
        builder.addFixer((DataFix)new EntityCustomNameToTextFix(schema46, false));
        builder.addFixer((DataFix)new ItemCustomNameToComponentFix(schema46, false));
        builder.addFixer((DataFix)new BlockEntityCustomNameToTextFix(schema46, false));
        ...
        builder.addFixer((DataFix)new ChoiceFix(schema58, false, "Command block block entity custom name fix", TypeReferences.BLOCK_ENTITY, "minecraft:command_block"){
        ...
        builder.addFixer((DataFix)new ChoiceFix(schema58, false, "Command block minecart custom name fix", TypeReferences.ENTITY, "minecraft:commandblock_minecart"){
        ...
        builder.addFixer((DataFix)new ObjectiveDisplayNameFix(schema68, false));
        builder.addFixer((DataFix)new TeamDisplayNameFix(schema68, false));
        builder.addFixer((DataFix)new ObjectiveRenderTypeFix(schema68, false));
        ...
        builder.addFixer((DataFix)new ItemLoreToTextFix(schema74, false));
        ...
        builder.addFixer((DataFix)new MapIdFix(schema84, false));
        ...
        builder.addFixer((DataFix)new VillagerXpRebuildFix(schema92, false));
        ...
        builder.addFixer((DataFix)new GameEventRenamesFix(schema95, "Rename sugar recipe", TypeReferences.RECIPE, Schemas.replacing("minecraft:sugar", "sugar_from_sugar_cane")));
        ...
        builder.addFixer((DataFix)new EntityUuidFix(schema107));
        builder.addFixer((DataFix)new BlockEntityUuidFix(schema107));
        builder.addFixer((DataFix)new PlayerUuidFix(schema107));
        builder.addFixer((DataFix)new WorldUuidFix(schema107));
        builder.addFixer((DataFix)new PersistentStateUuidFix(schema107));
        builder.addFixer((DataFix)new ItemStackUuidFix(schema107));
        Schema schema108 = builder.addSchema(2516, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new VillagerGossipFix(schema108, "minecraft:villager"));
        builder.addFixer((DataFix)new VillagerGossipFix(schema108, "minecraft:zombie_villager"));
        Schema schema109 = builder.addSchema(2518, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new JigsawPropertiesFix(schema109, false));
        builder.addFixer((DataFix)new JigsawRotationFix(schema109, false));
        Schema schema110 = builder.addSchema(2519, Schema2519::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema110, "Added Strider", TypeReferences.ENTITY));
        Schema schema111 = builder.addSchema(2522, Schema2522::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema111, "Added Zoglin", TypeReferences.ENTITY));
        Schema schema112 = builder.addSchema(2523, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RenameItemStackAttributesFix(schema112));
        Schema schema113 = builder.addSchema(2527, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BitStorageAlignFix(schema113));
        Schema schema114 = builder.addSchema(2528, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(ItemNameFix.create(schema114, "Rename soul fire torch and soul fire lantern", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:soul_fire_torch", (Object)"minecraft:soul_torch", (Object)"minecraft:soul_fire_lantern", (Object)"minecraft:soul_lantern"))));
        ...
        builder.addFixer((DataFix)new StriderGravityFix(schema115, false));
        Schema schema116 = builder.addSchema(2531, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RedstoneConnectionsFix(schema116));
        Schema schema117 = builder.addSchema(2533, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new VillagerFollowRangeFix(schema117));
        Schema schema118 = builder.addSchema(2535, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new EntityShulkerRotationFix(schema118));
        Schema schema119 = builder.addSchema(2550, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StructureSeparationDataFix(schema119));
        Schema schema120 = builder.addSchema(2551, Schema2551::new);
        builder.addFixer((DataFix)new WriteAndReadFix(schema120, "add types to WorldGenData", TypeReferences.WORLD_GEN_SETTINGS));
        Schema schema121 = builder.addSchema(2552, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GameEventRenamesFix(schema121, "Nether biome rename", TypeReferences.BIOME, Schemas.replacing("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema122 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GameEventRenamesFix(schema122, "Biomes fix", TypeReferences.BIOME, Schemas.replacing(FlatteningBiomeMapping.RENAMED_BIOMES)));
        Schema schema123 = builder.addSchema(2558, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new MissingDimensionFix(schema123, false));
        builder.addFixer((DataFix)new OptionFix(schema123, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
        Schema schema124 = builder.addSchema(2568, Schema2568::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema124, "Added Piglin Brute", TypeReferences.ENTITY));
        Schema schema125 = builder.addSchema(2571, Schema2571::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema125, "Added Goat", TypeReferences.ENTITY));
        Schema schema126 = builder.addSchema(2679, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new CauldronRenameFix(schema126, false));
        ...
        builder.addFixer((DataFix)new ChoiceTypesFix(schema128, "Added Sculk Sensor", TypeReferences.BLOCK_ENTITY));
        Schema schema129 = builder.addSchema(2686, Schema2686::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema129, "Added Axolotl", TypeReferences.ENTITY));
        Schema schema130 = builder.addSchema(2688, Schema2688::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema130, "Added Glow Squid", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new ChoiceTypesFix(schema130, "Added Glow Item Frame", TypeReferences.ENTITY));
        ...
        builder.addFixer(ItemNameFix.create(schema131, "Renamed copper block items to new oxidized terms", Schemas.replacing((Map<String, String>)immutableMap)));
        builder.addFixer(JigsawBlockNameFix.create(schema131, "Renamed copper blocks to new oxidized terms", Schemas.replacing((Map<String, String>)immutableMap)));
        ...
        builder.addFixer(ItemNameFix.create(schema132, "Rename copper item suffixes", Schemas.replacing((Map<String, String>)immutableMap2)));
        builder.addFixer(JigsawBlockNameFix.create(schema132, "Rename copper blocks suffixes", Schemas.replacing((Map<String, String>)immutableMap2)));
        Schema schema133 = builder.addSchema(2693, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new AddFlagIfNotPresentFix(schema133, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
        ...
        builder.addFixer(ItemNameFix.create(schema134, "Renamed grimstone block items to deepslate", Schemas.replacing((Map<String, String>)immutableMap3)));
        builder.addFixer(JigsawBlockNameFix.create(schema134, "Renamed grimstone blocks to deepslate", Schemas.replacing((Map<String, String>)immutableMap3)));
        Schema schema135 = builder.addSchema(2700, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(JigsawBlockNameFix.create(schema135, "Renamed cave vines blocks", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:cave_vines_head", (Object)"minecraft:cave_vines", (Object)"minecraft:cave_vines_body", (Object)"minecraft:cave_vines_plant"))));
        Schema schema136 = builder.addSchema(2701, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StructureFeatureChildrenPoolElementFix(schema136));
        Schema schema137 = builder.addSchema(2702, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ArrowPickupFix(schema137));
        Schema schema138 = builder.addSchema(2704, Schema2704::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema138, "Added Goat", TypeReferences.ENTITY));
        Schema schema139 = builder.addSchema(2707, Schema2707::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema139, "Added Marker", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new AddFlagIfNotPresentFix(schema139, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
        Schema schema140 = builder.addSchema(2710, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StatsRenameFix(schema140, "Renamed play_one_minute stat to play_time", (Map<String, String>)ImmutableMap.of((Object)"minecraft:play_one_minute", (Object)"minecraft:play_time")));
        Schema schema141 = builder.addSchema(2717, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(ItemNameFix.create(schema141, "Rename azalea_leaves_flowers", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:azalea_leaves_flowers", (Object)"minecraft:flowering_azalea_leaves"))));
        builder.addFixer(BlockNameFix.create(schema141, "Rename azalea_leaves_flowers items", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:azalea_leaves_flowers", (Object)"minecraft:flowering_azalea_leaves"))));
        Schema schema142 = builder.addSchema(2825, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new AddFlagIfNotPresentFix(schema142, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
        Schema schema143 = builder.addSchema(2831, Schema2831::new);
        builder.addFixer((DataFix)new UntaggedSpawnerFix(schema143));
        Schema schema144 = builder.addSchema(2832, Schema2832::new);
        builder.addFixer((DataFix)new WorldGenSettingsHeightAndBiomeFix(schema144));
        builder.addFixer((DataFix)new ChunkHeightAndBiomeFix(schema144));
        Schema schema145 = builder.addSchema(2833, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new WorldGenSettingsDisallowOldCustomWorldsFix(schema145));
        Schema schema146 = builder.addSchema(2838, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GameEventRenamesFix(schema146, "Caves and Cliffs biome renames", TypeReferences.BIOME, Schemas.replacing(LegacyBiomeMapping.MAP)));
        Schema schema147 = builder.addSchema(2841, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ProtoChunkTickListFix(schema147));
        Schema schema148 = builder.addSchema(2842, Schema2842::new);
        builder.addFixer((DataFix)new ChunkLevelTagRenameFix(schema148));
        Schema schema149 = builder.addSchema(2843, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new TicksInWrongChunkFix(schema149));
        builder.addFixer((DataFix)new GameEventRenamesFix(schema149, "Remove Deep Warm Ocean", TypeReferences.BIOME, Schemas.replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        Schema schema150 = builder.addSchema(2846, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new AdvancementRenameFix(schema150, false, "Rename some C&C part 2 advancements", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:husbandry/play_jukebox_in_meadows", (Object)"minecraft:adventure/play_jukebox_in_meadows", (Object)"minecraft:adventure/caves_and_cliff", (Object)"minecraft:adventure/fall_from_world_height", (Object)"minecraft:adventure/ride_strider_in_overworld_lava", (Object)"minecraft:nether/ride_strider_in_overworld_lava"))));
        Schema schema151 = builder.addSchema(2852, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new WorldGenSettingsDisallowOldCustomWorldsFix(schema151));
        Schema schema152 = builder.addSchema(2967, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StructureSettingsFlattenFix(schema152));
        Schema schema153 = builder.addSchema(2970, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StructuresToConfiguredStructuresFix(schema153));
        Schema schema154 = builder.addSchema(3076, Schema3076::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema154, "Added Sculk Catalyst", TypeReferences.BLOCK_ENTITY));
        Schema schema155 = builder.addSchema(3077, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ChunkDeleteIgnoredLightDataFix(schema155));
        Schema schema156 = builder.addSchema(3078, Schema3078::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema156, "Added Frog", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new ChoiceTypesFix(schema156, "Added Tadpole", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new ChoiceTypesFix(schema156, "Added Sculk Shrieker", TypeReferences.BLOCK_ENTITY));
        Schema schema157 = builder.addSchema(3081, Schema3081::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema157, "Added Warden", TypeReferences.ENTITY));
        Schema schema158 = builder.addSchema(3082, Schema3082::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema158, "Added Chest Boat", TypeReferences.ENTITY));
        Schema schema159 = builder.addSchema(3083, Schema3083::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema159, "Added Allay", TypeReferences.ENTITY));
        Schema schema160 = builder.addSchema(3084, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GameEventRenamesFix(schema160, "game_event_renames_3084", TypeReferences.GAME_EVENT_NAME, Schemas.replacing((Map<String, String>)ImmutableMap.builder().put((Object)"minecraft:block_press", (Object)"minecraft:block_activate").put((Object)"minecraft:block_switch", (Object)"minecraft:block_activate").put((Object)"minecraft:block_unpress", (Object)"minecraft:block_deactivate").put((Object)"minecraft:block_unswitch", (Object)"minecraft:block_deactivate").put((Object)"minecraft:drinking_finish", (Object)"minecraft:drink").put((Object)"minecraft:elytra_free_fall", (Object)"minecraft:elytra_glide").put((Object)"minecraft:entity_damaged", (Object)"minecraft:entity_damage").put((Object)"minecraft:entity_dying", (Object)"minecraft:entity_die").put((Object)"minecraft:entity_killed", (Object)"minecraft:entity_die").put((Object)"minecraft:mob_interact", (Object)"minecraft:entity_interact").put((Object)"minecraft:ravager_roar", (Object)"minecraft:entity_roar").put((Object)"minecraft:ring_bell", (Object)"minecraft:block_change").put((Object)"minecraft:shulker_close", (Object)"minecraft:container_close").put((Object)"minecraft:shulker_open", (Object)"minecraft:container_open").put((Object)"minecraft:wolf_shaking", (Object)"minecraft:entity_shake").build())));
        Schema schema161 = builder.addSchema(3086, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new EntityVariantTypeFix(schema161, "Change cat variant type", TypeReferences.ENTITY, "minecraft:cat", "CatType", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), catVariants -> {
        ...
        builder.addFixer((DataFix)new AdvancementCriteriaRenameFix(schema161, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> (String)immutableMap4.getOrDefault(string, string)));
        Schema schema162 = builder.addSchema(3087, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new EntityVariantTypeFix(schema162, "Change frog variant type", TypeReferences.ENTITY, "minecraft:frog", "Variant", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), frogVariants -> {
        ...
        builder.addFixer((DataFix)new EntityPaintingFieldsRenameFix(schema163));
        Schema schema164 = builder.addSchema(3093, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GoatMissingStateFix(schema164));
        Schema schema165 = builder.addSchema(3094, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GoatHornIdFix(schema165));
        Schema schema166 = builder.addSchema(3097, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RemoveFilteredBookTextFix(schema166));
        builder.addFixer((DataFix)new RemoveFilteredSignTextFix(schema166));
        Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
        builder.addFixer((DataFix)new RenameVariantsFix(schema166, "Rename british shorthair", TypeReferences.ENTITY, "minecraft:cat", map));
        builder.addFixer((DataFix)new AdvancementCriteriaRenameFix(schema166, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", string -> map.getOrDefault(string, (String)string)));
        builder.addFixer((DataFix)new PointOfInterestRemoveFix(schema166, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
        Schema schema167 = builder.addSchema(3108, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BlendingDataRemoveFromNetherEndFix(schema167));
        Schema schema168 = builder.addSchema(3201, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsProgrammerArtFix(schema168));
        Schema schema169 = builder.addSchema(3202, Schema3202::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema169, "Added Hanging Sign", TypeReferences.BLOCK_ENTITY));
        Schema schema170 = builder.addSchema(3203, Schema3203::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema170, "Added Camel", TypeReferences.ENTITY));
        Schema schema171 = builder.addSchema(3204, Schema3204::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema171, "Added Chiseled Bookshelf", TypeReferences.BLOCK_ENTITY));
        Schema schema172 = builder.addSchema(3209, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ItemInstanceSpawnEggFix(schema172, false, "minecraft:pig_spawn_egg"));
        Schema schema173 = builder.addSchema(3214, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsAmbientOcclusionFix(schema173));
        Schema schema174 = builder.addSchema(3319, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsAccessibilityOnboardFix(schema174));
        Schema schema175 = builder.addSchema(3322, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StatusEffectDurationFix(schema175));
        Schema schema176 = builder.addSchema(3325, Schema3325::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema176, "Added displays", TypeReferences.ENTITY));
        Schema schema177 = builder.addSchema(3326, Schema3326::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema177, "Added Sniffer", TypeReferences.ENTITY));
        Schema schema178 = builder.addSchema(3327, Schema3327::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema178, "Archaeology", TypeReferences.BLOCK_ENTITY));
        Schema schema179 = builder.addSchema(3328, Schema3328::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema179, "Added interaction", TypeReferences.ENTITY));
        Schema schema180 = builder.addSchema(3438, Schema3438::new);
        builder.addFixer(RenameBlockEntityFix.create(schema180, "Rename Suspicious Sand to Brushable Block", Schemas.replacing("minecraft:suspicious_sand", "minecraft:brushable_block")));
        builder.addFixer((DataFix)new EntityBrushableBlockFieldsRenameFix(schema180));
        ...
        builder.addFixer((DataFix)new ChoiceTypesFix(schema180, "Added calibrated sculk sensor", TypeReferences.BLOCK_ENTITY));
        Schema schema181 = builder.addSchema(3439, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new UpdateSignTextFormatFix(schema181, "Updated sign text format for Signs", "minecraft:sign"));
        builder.addFixer((DataFix)new UpdateSignTextFormatFix(schema181, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
        Schema schema182 = builder.addSchema(3440, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GameEventRenamesFix(schema182, "Replace experimental 1.20 overworld", TypeReferences.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, Schemas.replacing("minecraft:overworld_update_1_20", "minecraft:overworld")));
        builder.addFixer((DataFix)new RemoveFeatureTogglesFix(schema182, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
        Schema schema183 = builder.addSchema(3441, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BlendingDataFix(schema183));
        ...
        builder.addFixer((DataFix)new DecoratedPotFieldRenameFix(schema185));
        Schema schema186 = builder.addSchema(3450, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RenameChunkStatusFix(schema186, "Remove liquid_carvers and heightmap chunk statuses", Schemas.replacing(Map.of("liquid_carvers", "carvers", "heightmaps", "spawn"))));
        Schema schema187 = builder.addSchema(3451, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ChunkDeleteLightFix(schema187));
    }
