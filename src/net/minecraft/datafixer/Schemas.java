...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer((DataFix)new RecipeFix(schema65, false));
        ...
        builder.addFixer((DataFix)new RecipeRenamingFix(schema67, false));
        ...
        builder.addFixer((DataFix)new RecipeRenameFix(schema95, false, "Rename sugar recipe", Schemas.replacing("minecraft:sugar", "sugar_from_sugar_cane")));
        ...
        builder.addFixer((DataFix)new BiomeRenameFix(schema121, false, "Nether biome rename", (Map<String, String>)ImmutableMap.of((Object)"minecraft:nether", (Object)"minecraft:nether_wastes")));
        Schema schema122 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BiomesFix(schema122, false));
        ...
        builder.addFixer((DataFix)new BiomeRenameFix(schema146, false, "Caves and Cliffs biome renames", (Map<String, String>)LegacyBiomeMapping.MAP));
        ...
        builder.addFixer((DataFix)new BiomeRenameFix(schema149, false, "Remove Deep Warm Ocean", Map.of("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        ...
        builder.addFixer((DataFix)new BlendingDataFix(schema163));
        Schema schema164 = builder.addSchema(3090, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new EntityPaintingFieldsRenameFix(schema164));
        Schema schema165 = builder.addSchema(3093, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GoatMissingStateFix(schema165));
        Schema schema166 = builder.addSchema(3094, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new GoatHornIdFix(schema166));
        Schema schema167 = builder.addSchema(3097, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RemoveFilteredBookTextFix(schema167));
        builder.addFixer((DataFix)new RemoveFilteredSignTextFix(schema167));
        Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
        builder.addFixer((DataFix)new RenameVariantsFix(schema167, "Rename british shorthair", TypeReferences.ENTITY, "minecraft:cat", map));
        builder.addFixer((DataFix)new AdvancementCriteriaRenameFix(schema167, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", string -> map.getOrDefault(string, (String)string)));
        builder.addFixer((DataFix)new PointOfInterestRemoveFix(schema167, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
        Schema schema168 = builder.addSchema(3108, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BlendingDataRemoveFromNetherEndFix(schema168));
        Schema schema169 = builder.addSchema(3201, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsProgrammerArtFix(schema169));
        Schema schema170 = builder.addSchema(3202, Schema3202::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema170, "Added Hanging Sign", TypeReferences.BLOCK_ENTITY));
        Schema schema171 = builder.addSchema(3203, Schema3203::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema171, "Added Camel", TypeReferences.ENTITY));
        Schema schema172 = builder.addSchema(3204, Schema3204::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema172, "Added Chiseled Bookshelf", TypeReferences.BLOCK_ENTITY));
        Schema schema173 = builder.addSchema(3209, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ItemInstanceSpawnEggFix(schema173, false, "minecraft:pig_spawn_egg"));
        Schema schema174 = builder.addSchema(3214, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsAmbientOcclusionFix(schema174));
        Schema schema175 = builder.addSchema(3319, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsAccessibilityOnboardFix(schema175));
        Schema schema176 = builder.addSchema(3322, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new StatusEffectDurationFix(schema176));
        Schema schema177 = builder.addSchema(3325, Schema3325::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema177, "Added displays", TypeReferences.ENTITY));
        Schema schema178 = builder.addSchema(3326, Schema3326::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema178, "Added Sniffer", TypeReferences.ENTITY));
        Schema schema179 = builder.addSchema(3327, Schema3327::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema179, "Archaeology", TypeReferences.BLOCK_ENTITY));
        Schema schema180 = builder.addSchema(3328, Schema3328::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema180, "Added interaction", TypeReferences.ENTITY));
    }
