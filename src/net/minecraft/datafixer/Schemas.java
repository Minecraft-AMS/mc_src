...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer((DataFix)new RecipeRenameFix(schema96, false, "Rename sugar recipe", Schemas.replacing("minecraft:sugar", "sugar_from_sugar_cane")));
        builder.addFixer((DataFix)new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", Schemas.replacing("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        builder.addFixer((DataFix)new AdvancementRenameFix(schema103, false, "Composter category change", Schemas.replacing("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        builder.addFixer(ItemNameFix.create(schema105, "Renamed fungi items to fungus", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:warped_fungi", (Object)"minecraft:warped_fungus", (Object)"minecraft:crimson_fungi", (Object)"minecraft:crimson_fungus"))));
        builder.addFixer(BlockNameFix.create(schema105, "Renamed fungi blocks to fungus", Schemas.replacing((Map<String, String>)ImmutableMap.of((Object)"minecraft:warped_fungi", (Object)"minecraft:warped_fungus", (Object)"minecraft:crimson_fungi", (Object)"minecraft:crimson_fungus"))));
        ...
        builder.addFixer((DataFix)new ChoiceTypesFix(schema126, "Added Goat", TypeReferences.ENTITY));
        Schema schema127 = builder.addSchema(2679, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new CauldronRenameFix(schema127, false));
        ...
        builder.addFixer((DataFix)new ChoiceTypesFix(schema129, "Added Sculk Sensor", TypeReferences.BLOCK_ENTITY));
        Schema schema130 = builder.addSchema(2686, Schema2686::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema130, "Added Axolotl", TypeReferences.ENTITY));
        Schema schema131 = builder.addSchema(2688, Schema2688::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema131, "Added Glow Squid", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new ChoiceTypesFix(schema131, "Added Glow Item Frame", TypeReferences.ENTITY));
        ...
        builder.addFixer(ItemNameFix.create(schema132, "Renamed copper block items to new oxidized terms", Schemas.replacing((Map<String, String>)immutableMap)));
        builder.addFixer(JigsawBlockNameFix.create(schema132, "Renamed copper blocks to new oxidized terms", Schemas.replacing((Map<String, String>)immutableMap)));
        ...
        builder.addFixer(ItemNameFix.create(schema133, "Rename copper item suffixes", Schemas.replacing((Map<String, String>)immutableMap2)));
        builder.addFixer(JigsawBlockNameFix.create(schema133, "Rename copper blocks suffixes", Schemas.replacing((Map<String, String>)immutableMap2)));
