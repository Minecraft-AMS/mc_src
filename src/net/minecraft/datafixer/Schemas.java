...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer((DataFix)new EntityCustomNameToComponentFix(schema48, false));
        builder.addFixer((DataFix)new ItemCustomNameToComponentFix(schema48, false));
        builder.addFixer((DataFix)new BlockEntityCustomNameToComponentFix(schema48, false));
        ...
        builder.addFixer(BlockNameFix.create(schema53, "Flowing fixer", string -> (String)ImmutableMap.of((Object)"minecraft:flowing_water", (Object)"minecraft:water", (Object)"minecraft:flowing_lava", (Object)"minecraft:lava").getOrDefault(string, string)));
        ...
        builder.addFixer(ItemNameFix.create(schema57, "Rename seagrass items", string -> (String)ImmutableMap.of((Object)"minecraft:sea_grass", (Object)"minecraft:seagrass", (Object)"minecraft:tall_sea_grass", (Object)"minecraft:tall_seagrass").getOrDefault(string, string)));
        builder.addFixer(BlockNameFix.create(schema57, "Rename seagrass blocks", string -> (String)ImmutableMap.of((Object)"minecraft:sea_grass", (Object)"minecraft:seagrass", (Object)"minecraft:tall_sea_grass", (Object)"minecraft:tall_seagrass").getOrDefault(string, string)));
        ...
        builder.addFixer(ItemNameFix.create(schema59, "Rename prismarine_brick(s)_* blocks", string -> (String)ImmutableMap.of((Object)"minecraft:prismarine_bricks_slab", (Object)"minecraft:prismarine_brick_slab", (Object)"minecraft:prismarine_bricks_stairs", (Object)"minecraft:prismarine_brick_stairs").getOrDefault(string, string)));
        builder.addFixer(BlockNameFix.create(schema59, "Rename prismarine_brick(s)_* items", string -> (String)ImmutableMap.of((Object)"minecraft:prismarine_bricks_slab", (Object)"minecraft:prismarine_brick_slab", (Object)"minecraft:prismarine_bricks_stairs", (Object)"minecraft:prismarine_brick_stairs").getOrDefault(string, string)));
        Schema schema60 = builder.addSchema(1488, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema60, "Rename kelp/kelptop", string -> (String)ImmutableMap.of((Object)"minecraft:kelp_top", (Object)"minecraft:kelp", (Object)"minecraft:kelp", (Object)"minecraft:kelp_plant").getOrDefault(string, string)));
        ...
        builder.addFixer((DataFix)new BiomesFix(schema69, false));
        ...
        builder.addFixer((DataFix)new RecipeRenamingFix(schema70, false));
        builder.addFixer((DataFix)new EntityTheRenameningBlock(schema70, true));
        builder.addFixer((DataFix)new SwimStatsRenameFix(schema70, false));
        Schema schema71 = builder.addSchema(1514, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ObjectiveDisplayNameFix(schema71, false));
        builder.addFixer((DataFix)new TeamDisplayNameFix(schema71, false));
        builder.addFixer((DataFix)new ObjectiveRenderTypeFix(schema71, false));
        ...
        builder.addFixer((DataFix)new AddTrappedChestFix(schema73, false));
        Schema schema74 = builder.addSchema(1800, Schema1800::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema74, "Added 1.14 mobs fix", TypeReferences.ENTITY));
        ...
        builder.addFixer((DataFix)new ChoiceTypesFix(schema75, "Added Illager Beast", TypeReferences.ENTITY));
        Schema schema76 = builder.addSchema(1802, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema76, "Rename sign blocks & stone slabs", string -> (String)ImmutableMap.of((Object)"minecraft:stone_slab", (Object)"minecraft:smooth_stone_slab", (Object)"minecraft:sign", (Object)"minecraft:oak_sign", (Object)"minecraft:wall_sign", (Object)"minecraft:oak_wall_sign").getOrDefault(string, string)));
        builder.addFixer(ItemNameFix.create(schema76, "Rename sign item & stone slabs", string -> (String)ImmutableMap.of((Object)"minecraft:stone_slab", (Object)"minecraft:smooth_stone_slab", (Object)"minecraft:sign", (Object)"minecraft:oak_sign").getOrDefault(string, string)));
        Schema schema77 = builder.addSchema(1803, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ItemLoreToComponentFix(schema77, false));
        Schema schema78 = builder.addSchema(1904, Schema1904::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema78, "Added Cats", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new EntityCatSplitFix(schema78, false));
        Schema schema79 = builder.addSchema(1905, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ChunkStatusFix(schema79, false));
        Schema schema80 = builder.addSchema(1906, Schema1906::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema80, "Add POI Blocks", TypeReferences.BLOCK_ENTITY));
        Schema schema81 = builder.addSchema(1909, Schema1909::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema81, "Add jigsaw", TypeReferences.BLOCK_ENTITY));
        Schema schema82 = builder.addSchema(1911, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ChunkStatusFix2(schema82, false));
        ...
        builder.addFixer((DataFix)new OminousBannerItemRenameFix(schema92, false));
        ...
        builder.addFixer((DataFix)new RecipeRenameFix(schema96, false, "Rename sugar recipe", string -> "minecraft:sugar".equals(string) ? "sugar_from_sugar_cane" : string));
        builder.addFixer((DataFix)new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", string -> "minecraft:recipes/misc/sugar".equals(string) ? "minecraft:recipes/misc/sugar_from_sugar_cane" : string));
        ...
        builder.addFixer(BlockNameFix.create(schema98, "Rename bee_hive block to beehive", string -> (String)ImmutableMap.of((Object)"minecraft:bee_hive", (Object)"minecraft:beehive").getOrDefault(string, string)));
