...
Hoglin {
    ...
    private static void addIdleTasks(Brain<ZoglinEntity> brain) {
        brain.setTaskList(Activity.IDLE, 10, (ImmutableList<Task<ZoglinEntity>>)ImmutableList.of(UpdateAttackTargetTask.create(ZoglinEntity::getHoglinTarget), LookAtMobWithIntervalTask.follow(8.0f, UniformIntProvider.create(30, 60)), new RandomTask(ImmutableList.of((Object)Pair.of(StrollTask.create(0.4f), (Object)2), (Object)Pair.of(GoTowardsLookTargetTask.create(0.4f, 3), (Object)2), (Object)Pair.of((Object)new WaitTask(30, 60), (Object)1)))));
    }
