...
public class HoglinBrain {
    ...
    private static RandomTask<HoglinEntity> makeRandomWalkTask() {
        return new RandomTask<HoglinEntity>((List<Pair<Task<HoglinEntity>, Integer>>)ImmutableList.of((Object)Pair.of(StrollTask.create(0.4f), (Object)2), (Object)Pair.of(GoTowardsLookTargetTask.create(0.4f, 3), (Object)2), (Object)Pair.of((Object)new WaitTask(30, 60), (Object)1)));
    }
