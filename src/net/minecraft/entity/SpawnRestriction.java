...
public class SpawnRestriction {
    ...
    private static <T extends MobEntity> void register(EntityType<T> type, Location location, Heightmap.Type heightmapType, class_4306<T> predicate) {
    ...
    static class Entry {
        ...
        public Entry(Heightmap.Type heightMapType, Location location, class_4306<?> arg) {
