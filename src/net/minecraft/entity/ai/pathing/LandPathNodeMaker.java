...
extends PathNodeMaker {
    ...
    private PathNodeType method_29303(MobEntity mobEntity, int i, int j, int k) {
        return (PathNodeType)((Object)this.field_25190.computeIfAbsent(BlockPos.asLong(i, j, k), l -> this.getNodeType(this.cachedWorld, i, j, k, mobEntity, this.entityBlockXSize, this.entityBlockYSize, this.entityBlockZSize, this.canOpenDoors(), this.canEnterOpenDoors())));
    }
