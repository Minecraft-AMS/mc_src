...
public class VillagerTaskListProvider {
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createWorkTasks(VillagerProfession profession, float f) {
        return ImmutableList.of(VillagerTaskListProvider.createBusyFollowTask(), (Object)Pair.of((Object)5, new RandomTask(ImmutableList.of((Object)Pair.of((Object)new VillagerWorkTask(), (Object)7), (Object)Pair.of((Object)new GoToIfNearbyTask(MemoryModuleType.JOB_SITE, 4), (Object)2), (Object)Pair.of((Object)new GoToNearbyPositionTask(MemoryModuleType.JOB_SITE, 1, 10), (Object)5), (Object)Pair.of((Object)new GoToSecondaryPositionTask(MemoryModuleType.SECONDARY_JOB_SITE, 0.4f, 1, 6, MemoryModuleType.JOB_SITE), (Object)5), (Object)Pair.of((Object)new FarmerVillagerTask(), (Object)(profession == VillagerProfession.FARMER ? 2 : 5))))), (Object)Pair.of((Object)10, (Object)new HoldTradeOffersTask(400, 1600)), (Object)Pair.of((Object)10, (Object)new FindInteractionTargetTask(EntityType.PLAYER, 4)), (Object)Pair.of((Object)2, (Object)new VillagerWalkTowardsTask(MemoryModuleType.JOB_SITE, f, 9, 100, 1200)), (Object)Pair.of((Object)3, (Object)new GiveGiftsToHeroTask(100)), (Object)Pair.of((Object)3, (Object)new ForgetCompletedPointOfInterestTask(profession.getWorkStation(), MemoryModuleType.JOB_SITE)), (Object)Pair.of((Object)99, (Object)new ScheduleActivityTask()));
    }
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createPanicTasks(VillagerProfession profession, float f) {
        float g = f * 1.5f;
        return ImmutableList.of((Object)Pair.of((Object)0, (Object)new StopPanickingTask()), (Object)Pair.of((Object)1, (Object)new GoToNearbyEntityTask(MemoryModuleType.NEAREST_HOSTILE, g)), (Object)Pair.of((Object)1, (Object)new GoToNearbyEntityTask(MemoryModuleType.HURT_BY_ENTITY, g)), (Object)Pair.of((Object)3, (Object)new FindWalkTargetTask(g, 2, 2)), VillagerTaskListProvider.createBusyFollowTask());
    }
    ...
    public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createHideTasks(VillagerProfession villagerProfession, float f) {
        int i = 2;
        return ImmutableList.of((Object)Pair.of((Object)0, (Object)new ForgetBellRingTask(15, 2)), (Object)Pair.of((Object)1, (Object)new HideInHomeTask(32, f * 1.25f, 2)), VillagerTaskListProvider.createBusyFollowTask());
    }
