...
extends FollowOwnerGoal {
    ...
    protected boolean method_6263(BlockPos pos) {
        ...
        return (blockState.hasSolidTopSurface(this.world, pos, this.tameable) || blockState.matches(BlockTags.LEAVES)) && this.world.isAir(pos.up()) && this.world.isAir(pos.up(2));
    }
}
