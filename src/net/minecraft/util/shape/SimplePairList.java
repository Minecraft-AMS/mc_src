...
implements PairList {
    private static final DoubleList field_27346 = DoubleLists.unmodifiable((DoubleList)DoubleArrayList.wrap((double[])new double[]{0.0}));
    ...
    public DoubleList getPairs() {
        return this.field_27347 <= 1 ? field_27346 : DoubleArrayList.wrap((double[])this.valueIndices, (int)this.field_27347);
    }
}
