...
extends FloatProvider {
    public static final Codec<ClampedNormalFloatProvider> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.FLOAT.fieldOf("mean").forGetter(clampedNormalFloatProvider -> Float.valueOf(clampedNormalFloatProvider.mean)), (App)Codec.FLOAT.fieldOf("deviation").forGetter(clampedNormalFloatProvider -> Float.valueOf(clampedNormalFloatProvider.deviation)), (App)Codec.FLOAT.fieldOf("min").forGetter(clampedNormalFloatProvider -> Float.valueOf(clampedNormalFloatProvider.min)), (App)Codec.FLOAT.fieldOf("max").forGetter(clampedNormalFloatProvider -> Float.valueOf(clampedNormalFloatProvider.max))).apply((Applicative)instance, ClampedNormalFloatProvider::new)).comapFlatMap(clampedNormalFloatProvider -> {
        if (clampedNormalFloatProvider.max < clampedNormalFloatProvider.min) {
            return DataResult.error((String)("Max must be larger than min: [" + clampedNormalFloatProvider.min + ", " + clampedNormalFloatProvider.max + "]"));
        }
        return DataResult.success((Object)clampedNormalFloatProvider);
    }, Function.identity());
    private float mean;
