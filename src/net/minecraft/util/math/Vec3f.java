...
public final class Vec3f {
    public static final Codec<Vec3f> CODEC = Codec.FLOAT.listOf().comapFlatMap(vec2 -> Util.toArray(vec2, 3).map(vec -> new Vec3f(((Float)vec.get(0)).floatValue(), ((Float)vec.get(1)).floatValue(), ((Float)vec.get(2)).floatValue())), vec -> ImmutableList.of((Object)Float.valueOf(vec.x), (Object)Float.valueOf(vec.y), (Object)Float.valueOf(vec.z)));
