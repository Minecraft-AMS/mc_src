...
IndexedIterable<T> {
    ...
    public <U> DataResult<Pair<T, U>> decode(DynamicOps<U> dynamicOps, U object2) {
        ...
        return Identifier.CODEC.decode(dynamicOps, object2).flatMap(pair -> {
            T object = this.get((Identifier)pair.getFirst());
            if (object == null) {
                return DataResult.error((String)("Unknown registry key: " + pair.getFirst()));
            }
            return DataResult.success((Object)Pair.of(object, (Object)pair.getSecond()), (Lifecycle)this.getEntryLifecycle(object));
        });
    }
