...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessorList> PROCESSORS_CODEC = Codec.either((Codec)LIST_CODEC.fieldOf("processors").codec(), LIST_CODEC).xmap(either -> (StructureProcessorList)either.map(structureProcessorList -> structureProcessorList, structureProcessorList -> structureProcessorList), Either::left);
