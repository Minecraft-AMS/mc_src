...
public abstract class StructurePoolElement {
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofLegacySingle(String id) {
        return projection -> new LegacySinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)new Identifier(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection);
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofSingle(String id) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)new Identifier(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection);
    }
