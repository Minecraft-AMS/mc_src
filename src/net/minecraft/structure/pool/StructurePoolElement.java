...
public abstract class StructurePoolElement {
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofLegacySingle(String id) {
        return projection -> new LegacySinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)new Identifier(id)), StructureProcessorLists.EMPTY, (StructurePool.Projection)projection);
    }
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofProcessedLegacySingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return projection -> new LegacySinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)new Identifier(id)), processorListEntry, (StructurePool.Projection)projection);
    }

    public static Function<StructurePool.Projection, SinglePoolElement> ofSingle(String id) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)new Identifier(id)), StructureProcessorLists.EMPTY, (StructurePool.Projection)projection);
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofProcessedSingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return projection -> new SinglePoolElement((Either<Identifier, StructureTemplate>)Either.left((Object)new Identifier(id)), processorListEntry, (StructurePool.Projection)projection);
    }
