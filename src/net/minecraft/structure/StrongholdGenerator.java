...
public class StrongholdGenerator {
    ...
    extends Piece {
        ...
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            int j;
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 10, 7, 15, false, random, field_15263);
            this.generateEntrance(world, random, boundingBox, Piece.EntranceType.GRATES, 4, 1, 0);
            int i = 6;
            this.fillWithOutline(world, boundingBox, 1, i, 1, 1, i, 14, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 9, i, 1, 9, i, 14, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 2, i, 1, 8, i, 2, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 2, i, 14, 8, i, 14, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 1, 1, 1, 2, 1, 4, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 8, 1, 1, 9, 1, 4, false, random, field_15263);
            ...
            this.fillWithOutline(world, boundingBox, 3, 1, 8, 7, 1, 12, false, random, field_15263);
            ...
            this.fillWithOutline(world, boundingBox, 4, 1, 5, 6, 1, 7, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 4, 2, 6, 6, 2, 7, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 4, 3, 7, 6, 3, 7, false, random, field_15263);
            for (int k = 4; k <= 6; ++k) {
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 9, 8, 10, true, random, field_15263);
            ...
            this.fillWithOutline(world, boundingBox, 1, 2, 1, 8, 2, 6, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 4, 1, 5, 4, 4, 9, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 8, 1, 5, 8, 4, 9, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 1, 4, 7, 3, 4, 9, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 1, 3, 5, 3, 3, 6, false, random, field_15263);
            ...
            this.fillWithOutline(world, boundingBox, 5, 1, 7, 7, 1, 8, false, random, field_15263);
    ...
    extends Piece {
        ...
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            ...
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 13, i - 1, 14, true, random, field_15263);
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 8, 4, 10, true, random, field_15263);
            ...
            this.fillWithOutline(world, boundingBox, 4, 1, 1, 4, 3, 1, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 4, 1, 3, 4, 3, 3, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 4, 1, 7, 4, 3, 7, false, random, field_15263);
            this.fillWithOutline(world, boundingBox, 4, 1, 9, 4, 3, 9, false, random, field_15263);
            for (int i = 1; i <= 3; ++i) {
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 10, 6, 10, true, random, field_15263);
            this.generateEntrance(world, random, boundingBox, this.entryDoor, 4, 1, 0);
    ...
    extends class_3466 {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 4, 4, 4, true, random, field_15263);
            this.generateEntrance(world, random, boundingBox, this.entryDoor, 1, 1, 0);
            Direction direction = this.getFacing();
            if (direction == Direction.NORTH || direction == Direction.EAST) {
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 4, 10, 7, true, random, field_15263);
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 4, 4, 6, true, random, field_15263);
            this.generateEntrance(world, random, boundingBox, this.entryDoor, 1, 1, 0);
    ...
    extends Piece {
        ...
        @Override
        public boolean generate(IWorld world, Random random, BlockBox boundingBox, ChunkPos pos) {
            this.fillWithOutline(world, boundingBox, 0, 0, 0, 4, 10, 4, true, random, field_15263);
            this.generateEntrance(world, random, boundingBox, this.entryDoor, 1, 7, 0);
