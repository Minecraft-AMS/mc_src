...
implements ParticleEffect {
    public static final Codec<VibrationParticleEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)PositionSource.CODEC.fieldOf("destination").forGetter(effect -> effect.destination), (App)Codec.INT.fieldOf("arrival_in_ticks").forGetter(vibrationParticleEffect -> vibrationParticleEffect.arrivalInTicks)).apply((Applicative)instance, VibrationParticleEffect::new));
