...
extends AbstractDustParticleEffect {
    ...
    public static final Codec<DustColorTransitionParticleEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Vec3f.CODEC.fieldOf("fromColor").forGetter(dustColorTransitionParticleEffect -> dustColorTransitionParticleEffect.color), (App)Vec3f.CODEC.fieldOf("toColor").forGetter(dustColorTransitionParticleEffect -> dustColorTransitionParticleEffect.toColor), (App)Codec.FLOAT.fieldOf("scale").forGetter(dustColorTransitionParticleEffect -> Float.valueOf(dustColorTransitionParticleEffect.scale))).apply((Applicative)instance, DustColorTransitionParticleEffect::new));
