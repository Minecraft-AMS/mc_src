...
extends AbstractDustParticleEffect {
    ...
    public static final Codec<DustColorTransitionParticleEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codecs.VECTOR_3F.fieldOf("fromColor").forGetter(effect -> effect.color), (App)Codecs.VECTOR_3F.fieldOf("toColor").forGetter(effect -> effect.toColor), (App)Codec.FLOAT.fieldOf("scale").forGetter(effect -> Float.valueOf(effect.scale))).apply((Applicative)instance, DustColorTransitionParticleEffect::new));
