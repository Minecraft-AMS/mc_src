...
extends AbstractDustParticleEffect {
    ...
    public static final Codec<DustColorTransitionParticleEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Vec3f.CODEC.fieldOf("fromColor").forGetter(effect -> effect.color), (App)Vec3f.CODEC.fieldOf("toColor").forGetter(effect -> effect.toColor), (App)Codec.FLOAT.fieldOf("scale").forGetter(effect -> Float.valueOf(effect.scale))).apply((Applicative)instance, DustColorTransitionParticleEffect::new));
