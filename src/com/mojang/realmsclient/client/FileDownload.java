        ...
        this.currentThread = new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    CloseableHttpResponse httpResponse = closeableHttpClient.execute((HttpUriRequest)FileDownload.this.request);
                    ...
                    ProgressListener progressListener = new ProgressListener(worldName.trim(), FileDownload.this.tempFile, levelStorageSource, downloadStatus, worldDownload);
                    ...
                    block40: {
                        block41: {
                            ...
                            try {
                                ...
                                httpResponse = closeableHttpClient.execute((HttpUriRequest)FileDownload.this.request);
                                downloadStatus.totalBytes = Long.parseLong(httpResponse.getFirstHeader("Content-Length").getValue());
                                if (httpResponse.getStatusLine().getStatusCode() != 200) {
                                    FileDownload.this.error = true;
                                    FileDownload.this.request.abort();
